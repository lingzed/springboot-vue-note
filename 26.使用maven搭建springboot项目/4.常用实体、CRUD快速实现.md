...
public class BookQuery extends Book {
    ...
    public BookQuery(Integer page, Integer pageSize) {
        this.page = page;
        this.pageSize = pageSize;
    }

    public BookQuery(Integer page, Integer pageSize, Date startDate, Date endDate) {
        this.page = page;
        this.pageSize = pageSize;
     ...
     * @return
     */
    public static BookQuery of(Integer page, Integer pageSize) {
        return new BookQuery(page, pageSize);
    }
     ...
     * @return
     */
    public static BookQuery of(Integer page, Integer pageSize, Date startDate, Date endDate) {
        return new BookQuery(page, pageSize, startDate, endDate);
    }
    ...
    public String toString() {
        return "BookQuery{page = " + page + ", pageSize = " + pageSize + ", startDate = " + startDate + ", endDate = " + endDate + "}";
    }
}
```
...
public class BookController {
    ...
    public Result<PageBean<Book>> getBookInfo(@RequestParam(defaultValue = "1") Integer page,
                                                ...
                                                Date startDate,
                                                Date endDate) {
        BookQuery bookQuery = BookQuery.of(page,pageSize,startDate,endDate);
